    ...
    <View className="mx-4 overflow-hidden rounded-2xl bg-white">
      ...
      <View className="p-4">
        ...
        <View className="mt-1 flex-row items-center gap-2">
          ...
          <View className="rounded-full bg-green-lighter px-2 py-1">
        ...
        <Text className="mt-1 font-mregular text-xs text-green">
        ...
        {quantity > 0 ? (
          ...
          >
            <Text
              className={`font-mbold text-base ${canIncrement ? "text-green" : "text-gray"}`}
            >
              + Add
            </Text>
          </Pressable>
